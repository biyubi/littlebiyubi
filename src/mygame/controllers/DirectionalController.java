 ...
 * @author diuxddr
 */
public class DirectionalController extends AbstractControl{
  
  float speed;
  Vector3f direction;
    
  public DirectionalController(Vector3f direction){
      super();
      speed = 1.0f;
 ...
 @Override
  public Control cloneForSpatial(Spatial spatial){
    final DirectionalController control = new DirectionalController(direction);
